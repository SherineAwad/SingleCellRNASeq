...
png("dCR1500.featureplot.pca.png")
...
png("dCR1500.featureplot.marker.png")
FeaturePlot(object = mydata,  
            features.plot = c("SPARCL1","VIM","SLC1A3","GPC3","HES1","SPARC"),
            cols.use = c("grey", "blue"),
            reduction.use = "tsne")

dev.off()

png("dCR1500.vnplot.marker.png")
VlnPlot(object = mydata,
        features.plot = c("SPARCL1","VIM","SLC1A3","GPC3","HES1","SPARC"), 
        use.raw = TRUE,
        y.log = TRUE)
