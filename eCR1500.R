...
mydata.data <- Read10X(data.dir = "Eout/outs/filtered_feature_bc_matrix")
...
png(filename ="eCR.mito.png",width = 600, height = 600, units = "px")
...
png("eCR1500.featureplot.pca.png")
...
png("eCR1500.featureplot.marker.png")
FeaturePlot(object = mydata, 
            features.plot = c("SPARCL1", "GPC3","SLC1A3", "HES1", "EEF1A1", "VIM"),
            cols.use = c("grey", "blue"),
            reduction.use = "tsne")

dev.off()

png("eCR1500.vnplot.marker.png")
VlnPlot(object = mydata,
        features.plot = c("SPARCL1", "GPC3","SLC1A3", "HES1", "EEF1A1","VIM"), 
        use.raw = TRUE,
        y.log = TRUE)
