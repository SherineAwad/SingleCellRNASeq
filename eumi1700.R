...
mydata.data<-read.table(file=paste0("/rds/project/yhbl2/rds-yhbl2-genehunter/SM/scRNAseq/","e.counts.tsv"),header=TRUE ,sep="\t", row.names =1)
...
png(filename ="eumi.mito.png",width = 600, height = 600, units = "px")
...
png("eumi1700.featureplot.pca.png")
FeaturePlot(object = mydata,
            features.plot = c("RTN1","GAP43","DCX","INA","MLLT11","PAK3"),
...
png("eumi1700.featureplot.marker.png")
FeaturePlot(object = mydata,
            features.plot = c("SPARCL1","FZD5","SLC1A3","GPC3","HES1","VIM"),
            cols.use = c("grey", "blue"),
            reduction.use = "tsne")

dev.off()

png("eumi1700.vnplot.marker.png")
VlnPlot(object = mydata,
        features.plot = c("SPARCL1","FZD5","SLC1A3","GPC3","HES1","VIM"), 
        use.raw = TRUE,
        y.log = TRUE)
