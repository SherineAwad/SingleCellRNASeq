...
mydata.data <- Read10X(data.dir = "Fout/outs/filtered_feature_bc_matrix")
...
png(filename ="fCR.mito.png",width = 600, height = 600, units = "px")
...
mydata <- FilterCells(object = mydata,
                    ...
                    low.thresholds = c(1500),
                    high.thresholds = c(3500))

png("fCR1500.before.hist.png")
hist(colSums(mydata@data),
     breaks = 100,
...
png("fCR1500.featureplot.pca.png")
FeaturePlot(object = mydata,
            features.plot = c("STMN2","RTN1","GAP43","DCX","INA","MAP1B"),  
...
png("fCR1500.featureplot.marker.png")
FeaturePlot(object = mydata,
            features.plot = c("SPARCL1","GPC3","VIM","EEF1A1","SLC1A3","SPARC"),
            cols.use = c("grey", "blue"),
            reduction.use = "tsne")

dev.off()

png("fCR1500.vnplot.marker.png")
VlnPlot(object = mydata,
        features.plot = c("SPARCL1","GPC3","VIM","EEF1A1","SLC1A3","SPARC"),
        use.raw = TRUE,
        y.log = TRUE)
