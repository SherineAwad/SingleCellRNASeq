...
mydata.data<-read.table(file=paste0("/rds/project/yhbl2/rds-yhbl2-genehunter/SM/scRNAseq/","f.counts.tsv"),header=TRUE ,sep="\t", row.names =1)
...
png(filename ="fumi.mito.png",width = 600, height = 600, units = "px")
...
png("fumi1700.featureplot.pca.png")
FeaturePlot(object = mydata,
            features.plot = c("SPARC","MGST1","CD99","TTYH1","SLC1A3","QKI"),
...
png("fumi1700.featureplot.marker.png")
FeaturePlot(object = mydata,
            features.plot = c("SPARCL1","GPC3","VIM","SLC1A3","FZD5","MGST1"),
            cols.use = c("grey", "blue"),
            reduction.use = "tsne")

dev.off()

png("fumi1700.vnplot.marker.png")
VlnPlot(object = mydata,
        features.plot = c("SPARCL1","GPC3","VIM","SLC1A3","FZD5","MGST1"), 
        use.raw = TRUE,
        y.log = TRUE)
